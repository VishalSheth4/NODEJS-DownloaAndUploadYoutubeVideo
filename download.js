...
// Step to install 
// npm install ydl-core@latest express nodemon
...
const videoFilePath = 'F:\\javascript\\youtubeVideo\\video.mp4'
const thumbFilePath = 'F:\\javascript\\youtubeVideo\\thumbnail.png'

// exports.uploadVideo = (title, description, tags) => {
  assert(fs.existsSync(videoFilePath))
  assert(fs.existsSync(thumbFilePath))

  const configData = require('./info.json');
  title = configData['title'];
  description = configData['shortDescription'];
